...
<Properties>
  <View=-46,-87,1759,941,0.898136,0,0>
  <Grid=10,10,1>
  <DataSet=13dBAt1800AvailiblePowergainMicrostripBends.dat>
  <DataDisplay=13dBAt1800AvailiblePowergainMicrostripBends.dpl>
  <OpenDisplay=1>
  <Script=13dBAt1800AvailiblePowergainMicrostripBends.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <MTEE MS6 1 590 298 -26 15 0 2 "Subst1" 1 "3.0622 mm" 1 "3.0622 mm" 1 "3.0622 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0 "showNumbers" 0>
  ...
  <MTEE MS5 1 150 298 -26 15 0 2 "Subst1" 1 "3.0622 mm" 1 "3.0622 mm" 1 "3.0622 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0 "showNumbers" 0>
  <MLIN MS1 1 40 150 -26 15 0 0 "Subst1" 1 "3.0622 mm" 1 "7.9176 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <MLIN MS3 1 270 300 -26 15 0 0 "Subst1" 1 "3.0622 mm" 1 "8.0065 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <MLIN MS2 1 690 140 -26 15 0 0 "Subst1" 1 "3.0622 mm" 1 "10.778 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <MLIN MS4 1 470 300 -26 15 0 0 "Subst1" 1 "3.0622 mm" 1 "24.334 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <Eqn Eqn1 1 40 10 -31 19 0 0 "K=Rollet(S)" 1 "yes" 0>
  <Eqn Eqn7 1 1170 10 -31 19 0 0 "Gamma_Out=S[2,2]+S[1,2]*S[2,1]*GammaS/(1-S[2,2]*GammaS)" 1 "Gamma_In=S[1,1]+S[1,2]*S[2,1]*GammaL/(1-S[1,1]*GammaL)" 1 "yes" 0>
  <Eqn Eqn2 1 1180 130 -31 19 0 0 "GT=dB((abs(S[2,1])/abs(S[1,2]))*(K-sqrt(K^2-1)))" 1 "yes" 0>
  <Eqn Eqn8 1 1180 220 -31 19 0 0 "y=1" 1 "phase_GammaOut=phase(Gamma_Out)" 1 "phase_GammaIn=phase(Gamma_In)" 1 "phase_GammaS=phase(GammaS)" 1 "phase_GammaL=phase(GammaL)" 1 "yes" 0>
  <SUBST Subst1 1 1470 370 -30 24 0 0 "4.4" 1 "1.6 mm" 1 "35 um" 1 "0.0018" 1 "0.022e-6" 1 "0.15e-6" 1>
  <Eqn Eqn6 1 1190 540 -31 19 0 0 "GammaL=(B2-sqrt(B2^-4*abs(C2)^2))/(2*C2)" 1 "yes" 0>
  <Eqn Eqn5 1 1260 650 -31 19 0 0 "GammaIndB=dB(abs(Gamma_In))" 1 "GammaOutdB=dB(abs(Gamma_Out))" 1 "yes" 0>
  <.SP SP1 1 430 10 0 81 0 0 "lin" 1 "1.5GHz" 1 "3 GHz" 1 "1000" 1 "yes" 0 "1" 1 "2" 0 "no" 0 "no" 0>
</Components>
<Wires>
...
<Diagrams>
  ...
  <Rect 820 710 240 160 3 #c0c0c0 1 00 1 1.75e+09 2e+07 1.85e+09 1 -100 100 100 1 -1 1 1 315 0 225 "" "" "" "">
	<"phase_GammaL" #ff0000 0 3 0 0 0>
	  <Mkr 1.80631e+09 -10 80 3 0 0>
	<"phase_GammaOut" #ff00ff 0 3 0 0 0>
	  <Mkr 1.80631e+09 190 81 3 0 0>
  </Rect>
