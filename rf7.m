...
disp("Power Gain circles example Sofokles")
S11_r = 0.61
Theta_S11_grad=165
S21_r=3.72
Theta_S21_grad=59
...
disp("")
S=smat([0.535 147.6 2.798 64.2 0.097 60.7 0.280 -71.4])
...
[c1,r1]=sgcirc(S,'p',13)% c 1 = 0 . 4443 ∠ 52 . 56 o , r 1 = 0 . 5212
[c2,r2]=sgcirc(S,'p',14)% c 2 = 0 . 5297 ∠ 52 . 56 o , r 2 = 0 . 4205
[c3,r3]=sgcirc(S,'p',15)% c 3 = 0 . 6253 ∠ 52 . 56 o , r 3 = 0 . 2968
...
figure
[c1,r1]=sgcirc(S,'a',13) % c 1 = 0 . 5384 ∠ − 162 . 67 o , r 1 = 0 . 4373
[c2,r2]=sgcirc(S,'a',14) % c 2 = 0 . 6227 ∠ − 162 . 67 o , r 2 = 0 . 3422
[c3,r3]=sgcirc(S,'a',15) % c 3 = 0 . 7111 ∠ − 162 . 67 o , r 3 = 0 . 2337
