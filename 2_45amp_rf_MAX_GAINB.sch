...
<Properties>
  <View=30,-74,1574,718,1.6393,0,82>
  <Grid=10,10,1>
  <DataSet=2_45amp_rf_MAX_GAINB.dat>
  <DataDisplay=2_45amp_rf_MAX_GAINB.dpl>
  <OpenDisplay=1>
  <Script=2_45amp_rf_MAX_GAINB.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <.SP ss 1 60 -10 0 79 0 0 "log" 1 "2.0 GHz" 1 "3 GHz" 1 "2701" 1 "no" 0 "1" 0 "2" 0 "no" 0 "no" 0>
  <MLIN StubLoad 1 780 20 15 -26 0 1 "RO3003_1" 1 "3.0622 mm" 1 "9.9806 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <MLIN StubSource 1 310 50 15 -26 0 1 "RO3003_1" 1 "3.0622 mm" 1 "11.921 mm" 1 "Hammerstad" 0 "Kirschning" 0 "26.85" 0>
  <Pac P2 1 880 240 18 -26 0 1 "2" 1 "50 Ohm" 1 "0 dBm" 0 "1 GHz" 0 "26.85" 0>
  <GND * 5 880 270 0 0 0 0>
</Components>
<Wires>
  ...
  <780 210 880 210 "" 0 0 0 "">
  <780 50 780 210 "" 0 0 0 "">
  <310 210 380 210 "" 0 0 0 "">
  <310 80 310 210 "" 0 0 0 "">
</Wires>
<Diagrams>
  <Rect 320 540 240 160 3 #c0c0c0 1 00 1 2e+09 2e+08 3e+09 1 -55.1066 50 17.7765 1 -1 1 1 315 0 225 "" "" "" "">
