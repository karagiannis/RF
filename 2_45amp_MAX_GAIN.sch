...
<Properties>
  <View=-46,-87,1230,777,1.26158,14,0>
  <Grid=10,10,1>
  <DataSet=2_45amp_MAX_GAIN.dat>
  <DataDisplay=2_45amp_MAX_GAIN.dpl>
  <OpenDisplay=1>
  <Script=2_45amp_MAX_GAIN.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <.SP SP1 1 430 10 0 79 0 0 "log" 1 "2.44 GHz" 1 "2.46 GHz" 1 "89" 1 "no" 0 "1" 0 "2" 0 "no" 0 "no" 0>
</Components>
<Wires>
